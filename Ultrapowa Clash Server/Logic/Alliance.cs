...
namespace UCS.Logic
{
    class Alliance
    {
        ...
        public Alliance(long id)
        {
            ...
            m_vScore = Convert.ToInt32(ConfigurationManager.AppSettings["AlliancesScore"]);
            m_vAllianceExperience = Convert.ToInt32(ConfigurationManager.AppSettings["AlliancesExperience"]);
            m_vAllianceLevel = Convert.ToInt32(ConfigurationManager.AppSettings["AlliancesLevel"]);
            m_vWonWars = 0;
            m_vLostWars = 0;
            m_vDrawWars = 0;
            m_vChatMessages = new List<StreamEntry>();
